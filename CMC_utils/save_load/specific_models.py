...
__all__ = ["save_tabnet_model", "load_tabnet_model", "save_xgboost_model", "load_xgboost_model", "load_xgboost_regressor_model"]
...
def load_xgboost_regressor_model(path: str) -> XGBRegressor:
    """
    Load XGBoost model
    Parameters
    ----------
