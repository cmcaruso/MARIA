...
def _load_pkl( path: str, **_ ) -> object:
    """
...
def _load_torch_model( path: str, device: str = "cpu" ) -> torch.nn.Module:
    """
...
def load_model(path: str, device: str = "cpu" ) -> Union[object, torch.nn.Module]:
    """
    ...
    model = load_options[ extension ](path, device=device)
